...
public class Main extends JFrame {
	...
	public Main() {
		...
		panel_Gestor.setBounds(10, 40, 304, 399);
		Panel_Principal.add(panel_Gestor);
		panel_Gestor.setLayout(null);
		panel_Gestor.setForeground(Color.BLACK);
		panel_Gestor.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Buscar Informacion", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		mntmAgregar.setIcon(new ImageIcon(Main.class.getResource("/Imagenes/Button-Add-icon (3).png")));
		...
		mntmMostrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//accion de mostrar
				if(!pila.SiVacia()){
				atxtMostrar.setText(pila.LimpiarPila());
				}else{
					JOptionPane.showMessageDialog(null, "No hay Datos","Pila Vacia",JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		mntmEliminar.addActionListener(new ActionListener() {
			...
			//accion de eliminar datos
				if(!pila.SiVacia()){
				atxtMostrar.setText(pila.Pop());
				}else{
					JOptionPane.showMessageDialog(null, "No hay Datos","Pila Vacia",JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		mntmEliminar.setIcon(new ImageIcon(Main.class.getResource("/Imagenes/Button-Delete-icon (3).png")));
